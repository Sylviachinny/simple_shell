...
/**
 * add_dict_to_the_end - Add a new node with key and value
 ...
 * or NULL on failure.
 */
shell_dict_t *add_dict_to_the_end(shell_dict_t **headptr, const char *key,
		const char *value)
{
...
/**
 * get_value - Retrieve the value associated with a key
 * in a linked list.
